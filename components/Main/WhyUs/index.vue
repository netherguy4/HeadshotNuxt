    ...
    <div class="container">
      ...
      <div class="why__content">
        ...
        <div class="why__text-wrapper">
          ...
          <p class="why__text">
            У нашому клубі є 6 різних локацій, загальний розмір яких становить
            більше ніж 22000 м2! Кожна локація унікальна, завдяки чому кожна гра
            у нас буде цікавою та новою!
          </p>
        </div>
        <div class="why__text-wrapper">
          <h6 class="why__subtitle subtitle">Якісне єкіпірування</h6>
          <p class="why__text">
            Ми ретельно перевіряємо обладнання і часто його оновлюємо, що може
            гарантувати безпеку при грі! Слідкувати за оновленнями можна у
            нашому Instagram!
          </p>
        </div>
        <div class="why__image-wrapper image-wrapper">
        ...
        <div class="why__text-wrapper">
          ...
          <p class="why__text">
            Ми працюємо на цьому ринку вже більше 15 років, і за цей час набули
            величезного досвіду та експерності в організації захоплюючих ігор та
            корпоративних подій.
          </p>
        </div>
        <div class="why__text-wrapper">
          ...
          <p class="why__text">
            Наш клуб пропонує широкий вибір послуг, які задовольнять будь-які
            ваші побажання. Від інтенсивних корпоративних ігор до захоплюючих
            квестів до Дня народження!
          </p>
        </div>
        <div class="why__image-wrapper image-wrapper">
        ...
        <div class="why__text-wrapper">
          ...
          <p class="why__text">
            Ми регулярно оновлюємо наші спеціальні пропозиції, щоб зробити ваше
            відвідування ще приємнішим. Ви можете отримати знижки на ігри та
            спеціальні пропозиції для корпоративів!
          </p>
        </div>
      </div>
    </div>
...
<script setup>
  // ! DO NOT TOUCH
  import frame1 from "@/assets/svg/frame1.svg?raw";
  import frame2 from "@/assets/svg/frame2.svg?raw";
  import frame3 from "@/assets/svg/frame3.svg?raw";
...
<style lang="scss" scoped>
  .why {
    ...
    &__content {
      ...
      padding: 25px 0 0;
      background:
        url("/svg/dash-straight.svg") 8px top/2px 2255.5px repeat-y,
        url("/svg/white-ellipse.svg") 0 0/18px 18px no-repeat,
        url("/svg/white-ellipse.svg") bottom left/18px 18px no-repeat;
      @media (min-width: $L) {
        grid-template-columns: repeat(2, 1fr);
        padding: 0;
        grid-auto-rows: 1fr;
        background:
          url("/svg/dash-curved.svg") center/auto 95% no-repeat,
          url("/svg/white-ellipse.svg") 47.5% 2% no-repeat,
          url("/svg/white-ellipse.svg") 51.6% 98% no-repeat;
      }
    }
    &__image-wrapper {
      margin: 10% 0 0 32px;
